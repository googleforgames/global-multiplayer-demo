...
module "agones_gke_standard_clusters" {
  ...
  source = "git::https://github.com/googleforgames/agones.git//install/terraform/modules/gke/?ref=v1.42.0"
...
module "agones_gke_autopilot_clusters" {
  ...
  source = "git::https://github.com/googleforgames/agones.git//install/terraform/modules/gke-autopilot/?ref=v1.42.0"
