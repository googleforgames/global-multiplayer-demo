...
resource "local_file" "agones-skaffold-file" {
  ...
  filename = "${path.module}/${var.services_directory}/agones/install/skaffold.yaml"
}
...
resource "local_file" "agones-ae-lb-file" {
  ...
  filename = "${path.module}/${var.services_directory}/agones/install/${each.key}/kustomization.yaml"
}
...
resource "local_file" "agones-ns-file" {
  ...
  filename = "${path.module}/${var.services_directory}/agones/install/${each.key}/agones-system.yaml"
}
...
resource "local_file" "patch-agones-manifest" {
  ...
  filename = "${path.module}/${var.services_directory}/agones/endpoint-patch/patch-agones-allocator-${each.key}.yaml"
}
